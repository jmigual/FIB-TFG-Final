...
\usepackage{longtable} % Divide tables into multiple pages

\usepackage{tocloft}
\usepackage{lipsum}
\usepackage{todonotes}

% To avoid titles and paragraphs cut between pages
...
\pgfplotsset{compat=1.15, compat/show suggested version=false}
...
\setlength{\headheight}{14.5pt} %add some space to headheight to eliminate LaTeX "Overfull \vbox..." warnings
