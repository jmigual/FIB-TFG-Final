...
The results have been obtained using 4-\gls{CV}. The training parameters where a learning rate
of 0.001, 10 epochs and a batch size of 40. A bigger batch size could not be used because
...
It's curious to see that the network has not even learned what it had learned in the 
...
The network is composed by a total of seven convolutional blocks and then it has a final
...
The results using the deep siamese network
