...
\begin{table}
  ...
  \caption[Volume Only 4-CV results]{
    ...
    \todo[inline]{Update these results}
  }
\end{table}
...
These results are very similar from the ones previously obtained of 0.628 as explained in 
...
Results obtained with 4-\gls{CV} have been obtained with the Shallow Siamese model.
They are not really significant since they do not improve the current state-of-the-art 
results. Moreover, they are worse than the previous results so with this approach there 
has not been any improvements at all.
...
\begin{table}
  ...
  \begin{tabular}{|c||c|c|c||c|c|c|}
    ...
    \hhline{=======}
    \textbf{Total} & 65,414 & 188,612 & 20,868 & 0.764 & 0.918 & 0.620 \\
    \hline
  \end{tabular}
...
Some work has been done in this task although it's far for complete since all the efforts 
were centered around the model using radiomic features. The deep siamese network design
was inspired by Inception v4 design which did use a Residual Network to improve training
times. 
...
\begin{figure}
  ...
  \begin{subfigure}[b]{.4\textwidth}
    ...
    \caption{Residual network Stem Block}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{.59\textwidth}
    \centering
    \scalebox{.9}{\input{drawings/residual_block_a.tikz.tex}}
    \caption{Residual network convolutional Block A}
  \end{subfigure}
...
\begin{figure}\ContinuedFloat
  \begin{subfigure}[b]{.49\textwidth}
    \centering
    \scalebox{.9}{\input{drawings/residual_block_reduce_a.tikz.tex}}
    \caption{Residual network Reduction A}
  \end{subfigure}
  \begin{subfigure}[b]{.49\textwidth}
    \centering
    \scalebox{.9}{\input{drawings/residual_block_b.tikz.tex}}
    \caption{Residual network Block B}
  \end{subfigure}

  \caption{Residual Network blocks (continuation)}
\end{figure}

To do so, different types of blocks were used to create the network. 
...
\begin{table}
  ...
  \begin{tabular}{|c||c|c|c||c|c|c|}
    ...
    \textbf{Mixed} & \textbf{Train} & \textbf{Test} \\
    \hhline{=======}
    0 & 222.048 & 330.072 & 37.016 & 0,562 & 0,565 & 0,554 \\
    1 & 220.704 & 331.832 & 36.600 & 0,59 & 0,61 & 0,567 \\
    2 & 219.456 & 333.664 & 36.016 & 0,645 & 0,616 & 0,667 \\
    3 & 222.304 & 329.584 & 37.248 & 0,559 & 0,579 & 0,536 \\
    \hhline{=======}
    \textbf{Total} & 884,512 & 1,325,152 & 146,880 & 0.589 & 0.592 & 0.58 \\
    \hline
  \end{tabular}
